...
namespace NN {
	...
	public:
		friend bool write(const NN::NeuroNetwork& target, ostream& out, const string& act_type, const string& dact_type);
		friend bool read(NN::NeuroNetwork& target, istream& in);
	};
}  // namespace NN
